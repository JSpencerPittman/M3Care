...
class Observation_progation(MessagePassing):
    ...
    def __init__(self,
        ...
        self.increase_dim = nn.Linear(in_channels[1],  heads * out_channels*8)
        self.map_weights = nn.Parameter(torch.Tensor(self.n_nodes, heads * 16))
    ...
    def forward(self, x: Tensor | PairTensor, p_t: Tensor, edge_index: Adj, edge_weights=None, use_beta=False,
                edge_attr: OptTensor = None, return_attention_weights=None):
        # x (N x (TxOf))
        self.edge_index = edge_index  # (2 x E)
        self.p_t = p_t
